...
```bash
cd /tmp
# curl -LO https://github.com/markruler/swage/releases/download/v0.2.0/swage_v0.2.0_$(uname -s)_$(uname -p).tar.gz
wget https://github.com/markruler/swage/releases/download/v0.2.0/swage_v0.2.0_$(uname -s)_$(uname -p).tar.gz
tar zxvf swage_v0.2.0_$(uname -s)_$(uname -p).tar.gz
